...
public class Input {
	...
	protected volatile double[] AM_setpoints = { 0.0, 135.0, 850.0, 1700.0, 2000.0, 100.0, 790.0, 790.0, 680.0, 170.0,
			365.0 };
	...
	protected volatile double[] PT_setpoints = { 13.0, 96.5, 180.0, 180.0, 185.0, 190.5, 250.0, 250.0, 250.0, 278.5,
			13.0 };
