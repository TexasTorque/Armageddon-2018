...
public class RobotOutput {
	...
	private final TorqueMotor DB_leftFore;
	private final TorqueMotor DB_leftRear;
	private final TorqueMotor DB_rightFore;
	private final TorqueMotor DB_rightRear;

	private final TorqueMotor PT_motor;

	private final TorqueMotor AM_right;
	private final TorqueMotor AM_left;
	private final DoubleSolenoid CL_sole;

	private final TorqueMotor IN_left;
	private final TorqueMotor IN_right;
	private final DoubleSolenoid IN_leftDown;
	private final DoubleSolenoid IN_rightDown;
	private final DoubleSolenoid IN_out;
