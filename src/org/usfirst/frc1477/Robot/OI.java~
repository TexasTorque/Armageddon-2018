...
import org.usfirst.frc1477.Robot.commands.AutonomousCommand;
...
import org.usfirst.frc1477.Robot.commands.getGyro;
...
public class OI {
    ...
    public OI() {
        ...
        bButton.whenPressed(new MoveArm(1));
        xButton = new JoystickButton(joystick1, 3);
        xButton.whenPressed(new BlockIntake(4));
        yButton = new JoystickButton(joystick1, 4);
        yButton.whenPressed(new MoveArm(4));


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("Arcade Drive", new ArcadeDrive());
        SmartDashboard.putData("getGyro", new getGyro());
        SmartDashboard.putData("Compress", new Compress());
        SmartDashboard.putData("BlockIntake: buttonValue", new BlockIntake(0));
        SmartDashboard.putData("MoveArm: buttonValuePreset", new MoveArm(0));
