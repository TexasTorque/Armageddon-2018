...
public class RobotMap {
    ...
    public static SpeedController armRightMotor;
    public static SpeedController armLeftMotor;
    ...
    public static void init() {
        ...
        armRightMotor = new VictorSP(10);
        LiveWindow.addActuator("Arm", "Right Motor", (VictorSP) armRightMotor);
        armRightMotor.setInverted(false);
        armLeftMotor = new VictorSP(9);
        LiveWindow.addActuator("Arm", "Left Motor", (VictorSP) armLeftMotor);
