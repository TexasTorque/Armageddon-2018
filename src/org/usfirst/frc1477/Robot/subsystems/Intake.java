...
public class Intake extends Subsystem implements Sendable {
    ...
    public void periodic() {
    	if(SmartDashboard.getBoolean("Activate Intake Grip", false)) {
    		intakeGrip.set(Value.kForward);
    		SmartDashboard.putBoolean("Activate Intake Grip", true);
    	}
    	else {
    		intakeGrip.set(Value.kReverse);
    		SmartDashboard.putBoolean("Activate Intake Grip", false);
    	}
    	
    	if(SmartDashboard.getBoolean("Activate Intake Extender", false)) {
    		intakeGrip.set(Value.kForward);
    		SmartDashboard.putBoolean("Activate Intake Extender", true);
    	}
    	else {
    		intakeGrip.set(Value.kReverse);
    		SmartDashboard.putBoolean("Activate Intake Extender", false);
    	}
    	
    	if(SmartDashboard.getBoolean("Activate Intake In", false)) {
    		intakeIn();
    		SmartDashboard.putBoolean("Activate Intake In", true);
    	}
    	else if (SmartDashboard.getBoolean("Activate Intake Out", false)){
    		intakeOut();
    		SmartDashboard.putBoolean("Activate Intake Out",true);
    	}
    	else {
    		intakeStop();
    		SmartDashboard.putBoolean("Activate Intake In", false);
    	}
    }
